            ...
            <Row>
                <Navbar bg="dark" class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><Link style={{color:'#fff',fontWeight:'400',fontFamily: 'revert'}} class="nav-link" to='/about'>About us</Link></li>
                        <li class="nav-item"><Link style={{color:'#fff',fontWeight:'400',fontFamily: 'revert'}} class="nav-link" to='/contact'>Contact us</Link></li>
                    </ul>
